...
To set up an R project directory, run this code in README.Rmd or in the console (making sure you don't overwrite)
```{r}
library(here)
knitr::opts_knit$set(root.dir = here)
folder_names <- c("data","data/raw", "data/tidy","documentation", 
